...
public class AnsjAnalysisTest {
    ...
    public static void main(String args[]) throws IOException, ParseException {
        ...
        String sentence = "女篮四国赛-波多黎各逆转巴西 全队吃炸鸡庆祝呵呵太好吃了";
        ...
        filter.add("的") ;
        filter.add("女篮") ;
        AnsjAnalysis aas = new AnsjAnalysis(filter,false);
        // 读取索引
        //		Term term1 = new Term("text","父母"); 
        //		Term term2 = new Term("text","潜移默化"); 
        //		PhraseQuery query = new PhraseQuery(); 
        //		query.add(term1); 
        //		query.add(term2); 
        //		query.setSlop(1);
        QueryParser queryParser = new QueryParser(Version.LUCENE_40, "text", aas);
        Query query = queryParser.parse("text:\"女篮的的的四国赛\"~0");
